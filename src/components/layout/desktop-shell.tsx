 ...
 */
export function DesktopShell({ stepCounter, rail, aside, footer, children }: DesktopShellProps) {
  return (
    <div className="flex min-h-dvh w-full flex-col bg-paper">
      <div className="flex items-baseline gap-4 border-b-2 border-ink/40 px-6 py-3.5 lg:px-9">
        ...
        <div className="text-[13px] text-neutral-700">{PROPERTY.name} · 4–7 Sep</div>
